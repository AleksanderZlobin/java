...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            /**
             * Парсим данные и создаем объект
             */
            ...
            Application person = new Application(lastName, firstName, middleName, birthDateStr, phoneNumber, gender);
